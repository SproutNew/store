...
public class ProductServlet extends BaseServlet {
	...
	public String findProductByPname(HttpServletRequest request, HttpServletResponse response) throws Exception {
		//服务端获取到pname
		String pname=request.getParameter("pname");
		//根据pname查询对应的商品信息,
		ProductService ProductService=new ProductServiceImp();
		List<Product> pro=ProductService.findProductByPname(pname);
		//将商品放入request,
