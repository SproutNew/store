...
<div class="dtree">
	...
	d.add('0104','01','商品管理');			//${pageContext.request.contextPath}/AdminProductServlet?method=addProUI
										//${pageContext.request.contextPath}/admin/product/list.jsp
	d.add('010401','0104','商品管理','${pageContext.request.contextPath}/AdminProductServlet?method=findAllProducts&pflag=0','','mainFrame');
	d.add('010402','0104','已下架商品管理','${pageContext.request.contextPath}/AdminProductServlet?method=findAllProducts&pflag=1','','mainFrame');
	d.add('0105','01','订单管理');
