							...
							<form class="navbar-form navbar-right" role="search">
								<div class="form-group">
									...
									<%--  <c:forEach items="${page.list}" var="p">
										<div class="col-md-2">
										<a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPname&pname=${p.pname}">
										<img src="${pageContext.request.contextPath}/${p.pimage}" width="170" height="170" style="display: inline-block;">
										</a>
										<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPname&pname=${p.pname}" style='color:green'>${p.pname}</a></p>
